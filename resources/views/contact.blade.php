                ...
                <div class="bg-secondary p-5">
                    ...
                    <form action="/cita" method="POST" id="contacto">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="date" class="form-control bg-transparent" id="fechaUsuarioCita" name="fechaUsuarioCita" onChange="sinDomingos();" onblur="obtenerfechafinf1();" required="required">
